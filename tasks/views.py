...
def signup(request):
    if request.method == 'GET':
        ...
        if request.POST["password1"] != '' and request.POST["password2"] != '' and request.POST["username"] != '':
            ...
            return render(request, 'signup.html', {"form": UserCreationForm, "error": "La contraseña es distinta."})
        else:
            return render(request, 'signup.html', {"form": UserCreationForm, "error": "No se permiten valores nulos!"})
...
def create_task(request):
    if request.method == "GET":
        ...
        try:
            ...
            return render(request, 'create_task.html', {"form": TaskForm, "error": "Error creando tareas."})
